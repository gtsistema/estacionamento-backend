...
namespace Gp.Domain.Input.Receita
{
    public class ReceitaPutInput
    {
        ...
        public static ValidationResult Validar(ReceitaPutInput input)
        {
            return new DespesaPutInputValidate().Validate(input);
        }
    }

    public class DespesaPutInputValidate : AbstractValidator<ReceitaPutInput>
    {
