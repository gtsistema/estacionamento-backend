...
namespace Gp.Domain.Input.Receita
{
    public class ReceitaPostInput
    {
        ...
        public static ValidationResult Validar(ReceitaPostInput input)
        {
            return new DespesaPostInputValidate().Validate(input);
        }
    }

    public class DespesaPostInputValidate : AbstractValidator<ReceitaPostInput>
    {
